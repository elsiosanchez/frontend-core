...
export default {
  ...
  form: {
    ...
    pos: {
      ...
      applyDiscountInPercent: 'Aplicar Descuento Basado en Porcentaje',
      ...
      dialog: {
        viewOrderInformation: 'Ver Informacion de Pedido'
      },
      optionsPoinSales: {
        ...
        salesOrder: {
          ...
          giftCardPlaceholder: 'Escanee o Ingrese el Código de la Tarjeta Regalo',
          giftCardSearchCode: 'Ingrese Código para Realizar la Busqueda',
          ...
          giftCardNotFound: 'Tarjeta Regalo * No encontrado *',
          giftCardwithoutLines: 'Tarjeta de regalo sin Lineas',
      ...
      collect: {
        ...
        onlinePayment: {
          ...
          cancelPayment: {
            ...
            description: 'Actualmente hay un pago Online en Verificación desea cancelarlo'
          }
        }
      },
      keyLayout: {
