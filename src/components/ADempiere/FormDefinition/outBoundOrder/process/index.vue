      ...
      >
        ...
        >
          <el-row :gutter="24">
            ...
            <fieldset v-if="isCharterOrder" style="padding: 0.35em 0.75em 0.625em;border-radius: 6px;border: 1px solid #1890ff7a; min-width: 100%">
...
import DocumentDateField from './documentDateField.vue'
