  ...
  >
    ...
    >
      <el-row>
        ...
        <el-col :span="8">
          {{ $t('form.pos.tableProduct.quantity') }}: <b>{{ formatQuantity({ value: infoLine.quantity }) }}</b>
        </el-col>
        <el-col :span="8">
          {{ $t('form.productInfo.UM') }}: <b>{{ infoLine.uom.uom.name }}</b>
        </el-col>
        <el-col :span="8">
          {{ $t('form.pos.tableProduct.movementQuantity') }}: <b>{{ formatQuantity({ value: infoLine.movement_quantity }) }}</b>
        </el-col>
      </el-row>
    </el-card>
    <el-button
